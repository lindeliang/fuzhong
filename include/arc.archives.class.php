    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['pre'] = "<a href='$mlink' class='up'>上一篇：{$preRow['title']}</a> ";
            ...
            else
            {
                ...
                $this->PreNext['prewap'] = "上一篇：<span>没有了</span>";
            ...
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['next'] = "<a href='$mlink' class='down'>下一篇：{$nextRow['title']}</a> ";
            ...
            else
            {
                ...
                $this->PreNext['nextwap'] = "下一篇：<span>没有了</span>";
