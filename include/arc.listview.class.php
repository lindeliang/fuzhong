...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<li><a>上一页</a></li><li class=\"thisclass\"><a>1</a></li><li><a>下一页</a></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li><a>上一页</a></li><li class=\"thisclass\"><a>0</a></li><li><a>下一页</a></li>\r\n";
        }
        $purl = $this->GetCurUrl();
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li><a class='prev' href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a></li>\r\n";
        ...
        {
            $nextpage.="<li><a class='next' href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a></li>\r\n";
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<span class=\"pageBtn\"><a>共 1 页/".$this->TotalResult." 条记录</span></a>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<span class=\"pageBtn\"><a>共 0 页/".$this->TotalResult." 条记录</a></span>\r\n";
        }
        $maininfo = "<span class=\"pageBtn\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<span class='pageBtn'><a href='".$purl."PageNo=$prepagenum'>上一页</a></span>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<span class='pageBtn'><a href='".$purl."PageNo=$nextpagenum'>下一页</a></span>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<span class='pageBtn-selected'><a>$j</a></span>\r\n";
            }
            else
            {
                $listdd.="<span class='pageBtn'><a href='".$purl."PageNo=$j'>".$j."</a></span>\r\n";
            }
        }
